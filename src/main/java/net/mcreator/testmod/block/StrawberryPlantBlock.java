...
public class StrawberryPlantBlock extends TestmodModElements.ModElement {
	@ObjectHolder("testmod:strawberry_plant")
	public static final Block block = null;
	public StrawberryPlantBlock(TestmodModElements instance) {
		super(instance, 11);
	}
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
				...
				for (int j = 0; j < 5; ++j) {
					...
					if (world.isAirBlock(blockpos)) {
						...
						int k = 1 + random.nextInt(random.nextInt(1) + 1);
						k = Math.min(1, k);
						for (int l = 0; l < k; ++l) {
